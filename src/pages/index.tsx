...
<div className="absolute right-0 bottom-0 w-full lg:w-60 h-20 bg-[#AA6034] rounded-t-4xl text-center flex items-center justify-center">
  <p className="text-6xl">Start</p>
</div>
    </div>
  );
}
